...
/**
 * Questa classe rappresenta le opzioni che un utente ha a disposizione e ciò
 * che fanno queste opzioni durante il setup * di una gara.
 * È responsabile dell'accesso del giocatore, della gestione delle automobili,
 * della creazione del circuito e della * modifica (metodo truccaAuto()) della
 * propria automobile.
 *
...
public class Giocatore {
   ...
   * Gestisce la creazione della matrice per la cifratura, richiede in input i
   * dati dell'utente, cifra la password, e salva i dati su file.
   */
  public void accesso() {
  ...
  /**
   * Metodo per impostare l'username del giocatore.
   * 
   * @param username l'username del giocatore
   */
  ...
  /**
   * Metodo per impostare la password del giocatore.
   * 
   * @param password la password del giocatore
   */
  ...
  /**
   * Metodo per inserire il numero di automobili e i relativi dati.
   */
  public void numAuto() {
    ...
    // Inserimento dei dati per la tua auto
    ...
    // Inserimento dei dati per le altre auto
    ...
    if (risposta == 'Y' || risposta == 'y') {
      ...
      // Impostazione dei valori di default per gli elementi dell'ArrayList automobili
      ...
      for (int i = 1; i < numero_auto; i++) {
        ...
        Pilota defaultPilota = new Pilota(defaultNomePilota, defaultCognomePilota, defaultEtaPilota, defaultNazionalita,
            defaultSessoPilota, defaultAltezzaPilota, defaultPesoPilota);
        Random r = new Random();
  ...
  public void circuito() {
    ...
    System.out.println("Inserisci il numero di PitStop necessari al completamento della gara (max 5): ");
    nPitStop_circuito = Integer.valueOf(sc2.nextLine());
    while (nPitStop_circuito > 5) {
      System.out.println("Il numero di PitStop inserito è maggiore di 5. Inseriscine uno più piccolo: ");
      nPitStop_circuito = Integer.valueOf(sc2.nextLine());
    }
  ...
  /**
   * Metodo statico per ottenere la lista delle automobili.
   * 
   * @return la lista delle automobili
   */
